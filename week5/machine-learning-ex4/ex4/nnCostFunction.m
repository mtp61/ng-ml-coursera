...
for t = 1:m
    yk = yv(t,:)';
    a3k = a3(t,:)';
    delta3k = a3k - yk; % 10 x 1

    z2k = z2(t,:)';
    delta2k = (Theta2' * delta3k)(2:end) .* sigmoidGradient(z2k); % 25 x 1
...
D1 = D1 + lambda/m * [zeros(size(D1, 1), 1) Theta1(:,2:end)];
D2 = D2 + lambda/m * [zeros(size(D2, 1), 1) Theta2(:,2:end)];

% failed vectorized implementation
...
Theta1_grad = D1; % 25 x 401
Theta2_grad = D2; % 10 x 26
